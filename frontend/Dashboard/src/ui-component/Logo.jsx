...
export default function Logo() {
  ...
  return (
     ...
     */
    //  <img
    //   src={theme.palette.mode === 'dark' ? logoDark : logoH}
    //   alt="MonLogo"
    //   width="100"
    // />
    ...
    >
      ...
      <defs>
        <style>{`
          .logo-fill { fill: #2b2f33; } /* couleur sombre, modifiable */
          .logo-text { font-family: "Inter", "Helvetica Neue", Arial, sans-serif; font-weight: 700; font-size: 14px; fill: #2b2f33; }
        `}</style>
      </defs>
      ...
      <g transform="translate(4,4)">
        ...
        <rect x="0" y="7" rx="1.5" ry="1.5" width="3" height="9" className="logo-fill" />
        
        <rect x="6" y="0" rx="2.5" ry="2.5" width="10" height="24" className="logo-fill" />
       
        <rect x="16" y="9" rx="1" ry="1" width="18" height="6" className="logo-fill" />
       
        <rect x="34" y="0" rx="2.5" ry="2.5" width="10" height="24" className="logo-fill" />
        
        <rect x="46" y="7" rx="1.5" ry="1.5" width="3" height="9" className="logo-fill" />
      </g>

     
      <text x="58" y="21" className="logo-text">ercule</text>
    </svg>
    ...
    //     fill={theme.vars.palette.grey[900]}
    //   />
    //   <path
